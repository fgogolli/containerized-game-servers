...
export class gameLoadSimuPipeline extends Stack {
  ...
  const buildRole = new iam.Role(this, 'codeBuildDeployRoleSimu', { roleName: "codeBuildDeployRoleSimu",
        ...
        phases: {
          build: {
            commands: [
              ...
              `aws ssm put-parameter --type String --name game-load-simu-image-latest-tag --value $TAG --overwrite`
            ],
          }
