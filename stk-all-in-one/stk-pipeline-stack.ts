    ...
    buildSpec: codebuild.BuildSpec.fromObject(
      {
        ...
        phases: {
          build: {
            commands: [
              `cd stk-all-in-one/server/stk-assets-image-multiarch`,
        ...
        phases: {
          build: {
            commands: [
              ...
              `cd stk-all-in-one/server/stk-code-image-multiarch`,
    ...
    buildSpec: codebuild.BuildSpec.fromObject(
      {
        ...
        phases: {
          build: {
            commands: [
              `cd stk-all-in-one/server/stk-game-server-image-multiarch`,
              `chmod +x ./enable-buildx.sh && ./enable-buildx.sh`,
              `export AWS_ACCOUNT_ID="${this.account}"`,
              `export AWS_REGION="${this.region}"`,
              `export GAME_REPO="${GAME_REPO.valueAsString}"`,
